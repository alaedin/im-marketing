	...
	public defaults: any = {
		...
		aside: {
			...
			items: [
				...
				{
					title: 'Type des Maisons', // <= Title of the page
				...
				{
					title: 'Commercials',
					desc: 'Application Parameter', // <= Description of the page
					root: true,
					page: 'commercial',
					icon: 'flaticon-line-graph' // <= Choose the icon
				},
				{
					title: 'Configuration', // <= Title of the page
					desc: 'Application Parameter', // <= Description of the page
					root: true,
				...
				{
					title: 'Facture', // <= Title of the page
					desc: 'Application Parameter', // <= Description of the page
					root: true,
					page: 'facture', // <= URL
					icon: 'flaticon-line-graph' // <= Choose the icon
				...
				{
					title: 'Rendez-vous', // <= Title of the page
					desc: 'Application Parameter', // <= Description of the page
					root: true,
					page: 'rendez-vous', // <= URL
					icon: 'flaticon-line-graph' // <= Choose the icon
				},
				{
					title: 'Rendez-vous par commercial', // <= Title of the page
					desc: 'Application Parameter', // <= Description of the page
					root: true,
					page: 'rendez-vous-comm', // <= URL
					icon: 'flaticon-line-graph' // <= Choose the icon
				},
/*				{
